...
public class EventoDesifradoAsimetrico implements ActionListener {
  private final Practica4 practica4;

  public EventoDesifradoAsimetrico(Practica4 practica4) {
  ...
  public void actionPerformed(ActionEvent paramActionEvent) {
    try {
      ...
      practica4.procesoDescifradoAsimetrico();
    } catch (Exception exception) {
      // Manejo de posibles excepciones durante el descifrado
      practica4.mostrarMensaje("Error al descifrar la clave privada: " + exception.getMessage());
    }
  }
}
